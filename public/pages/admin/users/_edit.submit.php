...
$username = isset($_POST['user']) ? $database->clean_data($_POST['user']) : '';
...
$active = isset($_POST['active']) ? $database->clean_data($_POST['active']) : '';
...
// update username
if ($newusername) {
    $database->updateUserField($username, "username", $newusername);
}
